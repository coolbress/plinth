...
```text
create you/my-app (public, MIT, cli, as owner) from coolbress/plinth-template@v1.5.4 in /home/you/my-app; wall: ruleset + CodeQL; then the first pull request. rollback: on
```
